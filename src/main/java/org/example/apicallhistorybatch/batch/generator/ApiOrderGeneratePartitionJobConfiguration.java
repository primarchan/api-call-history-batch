...
public class ApiOrderGeneratePartitionJobConfiguration {
    ...
    @Bean
    public Job apiOrderGeneratorJob(Step managerStep) {
    ...
    /**
     * Manager Step 이 Worker Step 을 다루는 방법 정의
     */
    @Bean
    public PartitionHandler partitionHandler(Step apiOrderGeneratorStep) {
        final TaskExecutorPartitionHandler taskExecutorPartitionHandler = new TaskExecutorPartitionHandler();
        taskExecutorPartitionHandler.setStep(apiOrderGeneratorStep);
